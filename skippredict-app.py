...
This app predict whether the song will skip or not
...
df = df[['session_position','session_length','no_pause_before_play','short_pause_before_play','long_pause_before_play','hist_user_behavior_n_seekfwd','hist_user_behavior_n_seekback','hour_of_day','context_type','hist_user_behavior_reason_start']]
...
encode = ['context_type','hist_user_behavior_reason_start']
 for col in encode:
     ...
     df = concat([df,contexttype,histstart],axis=1)
     del df[col]
df = df[:1]
